package br.com.mmonteiro.bestway.usermanagement.config;
...
/**
 * On this class we can register all the beans that are going to be used on the project.
...
public class ApplicationConfiguration
{
    ...
    {
        Logger.getGlobal().info("Creating database cache.");
